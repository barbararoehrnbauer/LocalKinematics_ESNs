...
% This plotting script is compatible with compute_ESN_local_kinematics_Q4_github.m.
%
...
%
% The current-configuration coordinates are not used for the contour plots.
%
...
colormap(jet)
colorbar
title('Displacement field U_x, ground truth')
...
colormap(jet)
colorbar
title('Displacement field U_y, ground truth')
xlabel('X coordinate [\mum]')
ylabel('Y coordinate [\mum]')
axis equal
caxis([-2.6 1.6])
...
colormap(jet)
colorbar
title('Displacement magnitude |U|, ground truth')
xlabel('X coordinate [\mum]')
ylabel('Y coordinate [\mum]')
axis equal
xlim([-halfNetworkWidth, halfNetworkWidth])
...
colormap(jet)
colorbar
title('Green-Lagrange strain E_{11}, ground truth')
xlabel('X coordinate [\mum]')
ylabel('Y coordinate [\mum]')
axis equal
xlim([-halfNetworkWidth, halfNetworkWidth])
...
colormap(jet)
colorbar
title('Green-Lagrange strain E_{22}, groudn truth')
xlabel('X coordinate [\mum]')
ylabel('Y coordinate [\mum]')
axis equal
xlim([-halfNetworkWidth, halfNetworkWidth])
...
colormap(jet)
colorbar
title('Green-Lagrange strain E_{12}, ground truth')
xlabel('X coordinate [\mum]')
ylabel('Y coordinate [\mum]')
axis equal
xlim([-halfNetworkWidth, halfNetworkWidth])
...
colormap(jet)
colorbar
title('Deformation type exponent m, ground truth')
xlabel('X coordinate [\mum]')
ylabel('Y coordinate [\mum]')
axis equal
xlim([-halfNetworkWidth, halfNetworkWidth])
